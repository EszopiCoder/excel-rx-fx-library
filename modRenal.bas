...
Private Sub TestGFR()
    ...
    sCr = 1
    Metric = False
    CKDEPI = RxCalc_GFR_CKDEPI(Age, sCr, Female, Black)
    MDRD = RxCalc_GFR_MDRD(Age, sCr, Female, Black)
...
Attribute RxCalc_CrCl.VB_ProcData.VB_Invoke_Func = " \n20"
    ...
    If Age < 0 Or Weight <= 0 Or sCr < 0 Then
        RxCalc_CrCl = CVErr(xlErrNum)
        Exit Function
    ElseIf sCr = 0 Then
        RxCalc_CrCl = CVErr(xlErrDiv0)
        Exit Function
    End If
...
Public Function RxCalc_GFR_Class(ByVal eGFR As Integer) As String
Attribute RxCalc_GFR_Class.VB_Description = "Classify GFR."
Attribute RxCalc_GFR_Class.VB_ProcData.VB_Invoke_Func = " \n20"
...
Attribute RxCalc_GFR_CKDEPI.VB_ProcData.VB_Invoke_Func = " \n20"
    ...
    If Age < 18 Or sCr <= 0 Then
        RxCalc_GFR_CKDEPI = CVErr(xlErrNum)
        Exit Function
    End If
...
Attribute RxCalc_GFR_MDRD.VB_ProcData.VB_Invoke_Func = " \n20"
    ...
    ' Validate variables
    If Age < 18 Or sCr <= 0 Then
        RxCalc_GFR_MDRD = CVErr(xlErrNum)
        Exit Function
    End If
...
Public Sub RxCalc_RenalMacroArg()
    ...
    Application.MacroOptions "RxCalc_GFR_Class", "Classify GFR.", , , , , "RxCalc", , , , _
