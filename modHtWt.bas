...
Private Sub TestHtWt()
    ...
    Debug.Print "BMI: " & BMI & " kg/m^2 (" & RxCalc_BMIClass(BMI) & ")"
...
Attribute RxCalc_BMI.VB_ProcData.VB_Invoke_Func = " \n20"
    ...
    ' Return BMI
    RxCalc_BMI = Round(BMI, 1)
    
End Function

Public Function RxCalc_BMIClass(ByVal BMI As Single) As String
Attribute RxCalc_BMIClass.VB_Description = "Classify body mass index (BMI)."
Attribute RxCalc_BMIClass.VB_ProcData.VB_Invoke_Func = " \n20"
    ...
    Select Case BMI
        Case Is < 18.5
            RxCalc_BMIClass = "Underweight"
        Case 18.5 To 24.9
            RxCalc_BMIClass = "Normal"
        Case 25 To 29.9
            RxCalc_BMIClass = "Overweight"
        Case 30 To 34.9
            RxCalc_BMIClass = "Obese class I"
        Case 35 To 39.9
            RxCalc_BMIClass = "Obese class II"
        Case Is >= 40
            RxCalc_BMIClass = "Obese class III"
    End Select
...
Private Function PrimeToInches(strHeight As String, _
    Optional ByVal Metric As Boolean = False) As Single
...
Public Sub RxCalc_HtWtMacroArg()
    ...
    Application.MacroOptions "RxCalc_BMIClass", "Classify body mass index (BMI).", , , , , "RxCalc", , , , _
