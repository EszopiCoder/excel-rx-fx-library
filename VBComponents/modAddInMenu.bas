...
Option Explicit
Dim RxFxList(0 To 17) As Variant
...
Sub Auto_Open()
    ...
    RxFxList(11) = "Rx_GFR_CKDEPI()"
    RxFxList(12) = "Rx_GFR_MDRD()"
    RxFxList(13) = "Rx_GFR_Class()"
    RxFxList(14) = "Rx_DM_CF()"
    RxFxList(15) = "Rx_DM_CC()"
    RxFxList(16) = "Rx_PEDS_AdjAge()"
    RxFxList(17) = "Rx_PEDS_GFR_BS()"
