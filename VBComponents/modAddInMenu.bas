...
Option Explicit
Dim RxFxList(0 To 18) As Variant
...
Sub Auto_Open()
    ...
    RxFxList(0) = "Rx_AdjBW()"
    RxFxList(1) = "Rx_LBW()"
    RxFxList(2) = "Rx_IBW_Devine()"
    RxFxList(3) = "Rx_IBW_Baseline()"
    RxFxList(4) = "Rx_IBW_BMI()"
    RxFxList(5) = "Rx_IBW_Hume()"
    RxFxList(6) = "Rx_BMI()"
    RxFxList(7) = "Rx_BMI_Class()"
    RxFxList(8) = "Rx_BSA_DuBois()"
    RxFxList(9) = "Rx_BSA_Mosteller()"
    RxFxList(10) = "Rx_CrCl_CG()"
    RxFxList(11) = "Rx_CrCl_SC()"
    RxFxList(12) = "Rx_GFR_CKDEPI()"
    RxFxList(13) = "Rx_GFR_MDRD()"
    RxFxList(14) = "Rx_GFR_Class()"
    RxFxList(15) = "Rx_DM_CF()"
    RxFxList(16) = "Rx_DM_CC()"
    RxFxList(17) = "Rx_PEDS_AdjAge()"
    RxFxList(18) = "Rx_PEDS_GFR_BS()"
